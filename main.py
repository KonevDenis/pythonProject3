...
for input_data in stars:
    ...
    objects.add(input_data[0])  # проверяем на новое имя объекта
    dates.append(input_data[1])  # заносим в список даты
    filters.add(input_data[2].title())  # проверяем на новый фильтр
